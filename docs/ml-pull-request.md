...
* [Staging workspace registered model](https://adb-7851734333608688.8.azuredatabricks.net#mlflow/models/staging-mlops-stack-demo-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-mlops-stack-demo-model)
