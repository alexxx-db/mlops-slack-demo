...
# It is configured and can be executed as a training-job.tf job defined under ``mlops-stack-demo/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-stack-demo-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-mlops-stack-demo-model", label="Model Name"
)
