...
def _get_ml_config_value(env, key):
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"mlops-stack-demo have been deployed to {env} (see mlops-stack-demo"
...
def get_model_name(env, test_mode=False):
    ...
    if env == "dev" or test_mode:
        ...
        return f"mlops-stack-demo-model{resource_name_suffix}"
    else:
        # Read ml model name from mlops-stack-demo/terraform
        return _get_ml_config_value(env, "mlops-stack-demo_model_name")
