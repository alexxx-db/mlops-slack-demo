resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "mlops-stack-demo-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "mlops-stack-demo-cicd"
  project_directory_path       = "/mlops-stack-demo"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "mlops-stack-demo-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://adb-7851734333608688.8.azuredatabricks.net"
